...
# ╔═╡ 964d4c94-ecf3-40b3-837b-224d3ce360dc
using DifferentialEquations, Plots

# ╔═╡ 8cd54bba-9b89-11ee-0e45-4f284629bba9
md"""
# 4D-VAR

The name 4D-VAR stands for 4-dimensional variatonal data-assimilation. The fourth dimension points at time, the other three being the spatial dimensions. Varational assimilation denotes the method of finding the optimal solution by making small steps in the direction of the gradient of a cost-function. The cost-function is optimized under the constraint that the solution satisfies the equations of a simulation model. The controls for the optimization are often the starting point of the simulation. Long time-spans are usually cut into pieces and optimized one by one.
"""

# ╔═╡ 856a9400-f699-4fcb-8376-dd7504bf22bf


# ╔═╡ 16fd862e-3c44-448d-9f97-5f21507272fd
for i=1:10
	sleep(10)
end

# ╔═╡ af398f32-06ee-4662-826b-8859949b01ae
i
